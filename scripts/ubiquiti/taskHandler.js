...
async function logIn(page) {
  ...
  await page.waitForSelector('#headerLoginLink');
  await page.$eval('#headerLoginLink', (el) => el.click());
  ...
  // password
  await page.waitForSelector(utils.selectors.get('pass_selector'));
  await page.$eval(utils.selectors.get('pass_selector'), (el) => el.click());
  await page.type(utils.selectors.get('pass_selector'), myInfo.mypassw);
  ...
  await page.screenshot({ path: `${myInfo.snapShotPath}+login_complete.png` });
